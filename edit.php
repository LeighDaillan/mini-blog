...
<main class="max-w-6xl mx-auto ">
      ...
      <?php foreach($query as $q){?>
        ...
        <input type="text" name="title" placeholder="Blog Title" class="border border-black p-2 rounded-sm" value="<?php echo $q['title'] ?>" required/>
        <textarea name="content" placeholder="Blog Content" class="border border-black p-2 rounded-sm" required><?php echo $q['content']; ?></textarea>
        <?php } ?>
